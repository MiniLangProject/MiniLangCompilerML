...
```powershell
.\build\mlc_win64.exe .\benchmarks\crypto_compression.ml .\build\crypto_compression.exe -I .
...
```powershell
.\build\mlc_win64.exe .\benchmarks\file_io.ml .\build\file_io_bench.exe -I .
...
```powershell
.\build\mlc_win64.exe .\benchmarks\thread_allocation_churn.ml .\build\thread_allocation_churn.exe
...
```powershell
.\build\mlc_win64.exe .\benchmarks\language_optimizer.ml .\build\language_optimizer.exe -I .
...
```powershell
.\build\mlc_win64.exe .\benchmarks\concurrency.ml .\build\concurrency_bench.exe -I .
