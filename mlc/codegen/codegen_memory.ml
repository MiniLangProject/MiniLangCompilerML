...
const GC_MARK_STACK_QWORDS = 1048576
...
function emit_heap_init(state, heap_size)
  ...
  reserve_bytes = _heap_cfg_get_int(state, "reserve_bytes", HEAP_SIZE_DEFAULT)
...
function emit_alloc_function(state)
  ...
  state.asm = a.mov_rsp_disp32_rax(state.asm, 0x28)
  state.asm = a.mov_r64_membase_disp(state.asm, "r8", "r8", 16)
  state.asm = a.jmp(state.asm, l_free_loop)

  state.asm = a.mark(state.asm, l_free_found)
  state.asm = a.mov_r64_membase_disp(state.asm, "r9", "r8", 16)
  ...
  state.asm = a.mov_membase_disp_r64(state.asm, "r10", 16, "r9")
  ...
  state.asm = a.mov_membase_disp_imm32(state.asm, "rdx", 8, 0, true)
  state.asm = a.mov_rax_rip_qword(state.asm, "gc_free_head")
  state.asm = a.mov_membase_disp_r64(state.asm, "rdx", 16, "rax")
  state.asm = a.mov_r64_r64(state.asm, "rax", "rdx")
  state.asm = a.mov_rip_qword_rax(state.asm, "gc_free_head")

  state.asm = a.mov_membase_disp_imm32(state.asm, "rdx", c.GC_HEADER_SIZE + 0, c.OBJ_FREE, false)
  state.asm = a.mov_membase_disp_r64(state.asm, "r8", 0, "rcx")

  state.asm = a.mark(state.asm, l_free_nosplit)
  state.asm = a.mov_membase_disp_imm32(state.asm, "r8", 8, 0, true)
  state.asm = a.mov_membase_disp_imm32(state.asm, "r8", 16, 0, true)
  state.asm = a.mov_r64_r64(state.asm, "rax", "r8")
  ...
  state.asm = a.mov_membase_disp_imm32(state.asm, "rdx", 8, 0, true)
  state.asm = a.mov_membase_disp_imm32(state.asm, "rdx", 16, 0, true)
...
function emit_gc_collect_function(state)
  ...
  // r12 = &gc_mark_stack, gc_mark_top = 0
  ...
  state.asm = a.mov_r64_membase_disp(state.asm, "rcx", "rdx", 8)
  state.asm = a.test_r64_r64(state.asm, "rcx", "rcx")
  state.asm = a.jcc(state.asm, "ne", L_MARK_VALUE_RET)

  state.asm = a.mov_membase_disp_imm32(state.asm, "rdx", 8, 1, true)

  state.asm = a.mov_rax_rip_qword(state.asm, "gc_mark_top")
  state.asm = a.mov_r64_r64(state.asm, "r10", "rax")
  // Overflow guard: skip push when full.
  ...
  state.asm = a.mov_r64_mem_bis(state.asm, "rax", "rbx", "r8", 8, 0)
  state.asm = a.call(state.asm, L_MARK_VALUE)
  ...
  state.asm = a.mov_r32_membase_disp(state.asm, "edx", "rax", 4)
  state.asm = a.lea_r64_membase_disp(state.asm, "rbx", "rax", 16)
  state.asm = a.mov_r32_r32(state.asm, "r9d", "edx")
  ...
  // Sweep pass 1: mark->free conversion + max live end.
  state.asm = a.mov_rax_imm64(state.asm, 0)
  state.asm = a.mov_rip_qword_rax(state.asm, "gc_free_head")
  state.asm = a.mov_rax_rip_qword(state.asm, "heap_base")
  ...
  state.asm = a.jcc(state.asm, "be", L_SWEEP_ADV)
  state.asm = a.mov_r64_r64(state.asm, "r15", "rdx")
  state.asm = a.mark(state.asm, L_SWEEP_ADV)
  state.asm = a.add_r64_r64(state.asm, "rbx", "r10")
  state.asm = a.jmp(state.asm, L_SWEEP_LOOP)
  ...
  // Sweep pass 2: rebuild free list with coalescing.
  state.asm = a.mov_rax_imm64(state.asm, 0)
  state.asm = a.mov_rip_qword_rax(state.asm, "gc_free_head")
  state.asm = a.mov_rax_rip_qword(state.asm, "heap_base")
  state.asm = a.mov_r64_r64(state.asm, "rbx", "rax")
  ...
  state.asm = a.mov_rax_rip_qword(state.asm, "gc_free_head")
  state.asm = a.mov_membase_disp_r64(state.asm, "rbx", 16, "rax")
...
function emit_heap_count_function(state)
  ...
  state.asm = a.mov_r32_membase_disp(state.asm, "edx", "r10", c.GC_HEADER_SIZE)
  state.asm = a.cmp_r32_imm(state.asm, "edx", c.OBJ_FREE)
  state.asm = a.jcc(state.asm, "ne", l_live)
  ...
  state.asm = a.add_r64_imm(state.asm, "r8", 1)
  state.asm = a.mov_r64_membase_disp(state.asm, "rcx", "r10", 0)
  state.asm = a.add_r64_r64(state.asm, "r10", "rcx")
  state.asm = a.jmp(state.asm, l_loop)
...
function emit_heap_free_blocks_function(state)
  ...
  state.asm = a.sub_r64_imm(state.asm, "r13", 1)
  ...
  state.asm = a.mov_r64_membase_disp(state.asm, "r10", "r10", 16)
  state.asm = a.jmp(state.asm, l_loop)
