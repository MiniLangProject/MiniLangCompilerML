...
function emit_gc_collect_function(state)
  ...
  L_CONTEXT_LOOP = "gc_context_loop_" + lid
  L_CONTEXT_NEXT = "gc_context_next_" + lid
  ...
  state.asm = a.mov_r64_membase_disp(state.asm, "rcx", "rax", c.GC_OFF_BLOCK_SIZE)
  state.asm = a.and_r64_imm(state.asm, "rcx", c.GC_BLOCK_SIZE_MASK)
  state.asm = a.sub_r64_imm(state.asm, "rcx", c.GC_HEADER_SIZE + 8)
  state.asm = a.shr_r64_imm8(state.asm, "rcx", 3)
  state.asm = a.mov_r32_membase_disp(state.asm, "edx", "rax", 4)
  state.asm = a.cmp_r32_r32(state.asm, "edx", "ecx")
  state.asm = a.jcc(state.asm, "a", L_MARK_LOOP)
  ...
  state.asm = a.and_r64_imm(state.asm, "rcx", c.GC_BLOCK_SIZE_MASK)
  state.asm = a.cmp_r64_imm(state.asm, "rcx", c.GC_HEADER_SIZE + 24)
  ...
  state.asm = a.mov_r64_membase_disp(state.asm, "rcx", "r11", c.GC_OFF_BLOCK_SIZE)
  state.asm = a.and_r64_imm(state.asm, "rcx", c.GC_BLOCK_SIZE_MASK)
  state.asm = a.cmp_r64_imm(state.asm, "rcx", c.GC_HEADER_SIZE + 16)
  state.asm = a.jcc(state.asm, "b", L_MARK_LOOP)
  state.asm = a.sub_r64_imm(state.asm, "rcx", c.GC_HEADER_SIZE + 16)
  state.asm = a.shr_r64_imm8(state.asm, "rcx", 3)
