...
- [Windows x64 ZIP](https://github.com/MiniLangProject/MiniLangCompilerML/releases/download/v1.2.6/MiniLangCompilerML-1.2.6-windows-x64.zip)
- [Linux x64 tar.gz](https://github.com/MiniLangProject/MiniLangCompilerML/releases/download/v1.2.6/MiniLangCompilerML-1.2.6-linux-x64.tar.gz)
