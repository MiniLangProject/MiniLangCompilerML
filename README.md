...
Current stable release: **1.2.9**. See the [changelog](CHANGELOG.md) and
[release notes](RELEASE_NOTES_1.2.9.md).
...
itself with `build.ps1`. Release 1.2.9 includes ready-to-run **Windows and
...
`MiniLang Compiler 1.2.9`. `.\build\mlc_win64.exe --help` prints a short usage
summary.
...
`"windows"`, `"x64"`, `"win64"`, `"pe"`, `8` and `"1.2.9"`; Linux selects
`"linux"`, `"x64"`, `"sysv"`, `"elf"`, `8` and `"1.2.9"`. No
