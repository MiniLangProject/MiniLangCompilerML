...
[crypto/compression report](https://github.com/MiniLangProject/MiniLangCompilerML/blob/v1.2.9/docs/reports/CRYPTO_COMPRESSION_2026-09-20.md)
...
Both CLI version switches and `MINILANG_VERSION` report 1.2.9. Ready-to-run
Windows x64 and Linux x64 compiler packages include `std/`, a quick-start
example, build metadata, and SHA-256 sidecars. Extract the full package and
run `mlc.exe` on Windows or `./mlc` on Linux. No Python installation is needed
